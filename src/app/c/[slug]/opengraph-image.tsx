...
export default async function PublicEventOGImage({ params }: Props) {
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '48px' }}>
        ...
        <span style={{ color: '#ffffff', fontSize: '24px', fontWeight: 600 }}>
          Churras<span style={{ color: '#F5A623' }}>King</span>
        </span>
      </div>
      ...
      {hostName && (
        <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '20px', marginBottom: '24px' }}>
      ...
      <div style={{ display: 'flex', gap: '32px', alignItems: 'center' }}>
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '16px' }}>confirmados</span>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '14px' }}>
            Confirme sua presença no ChurrasKing
          </span>
        </div>
      </div>
    </div>,
